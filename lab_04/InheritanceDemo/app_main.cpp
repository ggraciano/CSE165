...
private:
    ...
    float r, g, b;
public:
    TextBox(): text(""), x(0.0), y(0.0), font(GLUT_BITMAP_HELVETICA_18), r(0.0), g(0.0), b(0.0){}
    TextBox(string text, float x, float y, void *font = GLUT_BITMAP_HELVETICA_18, float r = 1.0, float g = 1.0, float b = 1.0): text(text), x(x), y(y), font(font), r(r), g(g), b(b) {}
